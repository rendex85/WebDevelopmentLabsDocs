...
1. **Выполнить практики 1.1-1.3.**  Их можно реализовать на примере, приведенном в текстах практик или используя выбранную
   тему. ***Обратите внимания на задания в конце практик - они должны входить в реализацию ЛР***.
   Практики можно предоставить в любом из ниже приведенных вариантов:
...
Предоставляется в 
[формате github-pages](https://docs.google.com/document/d/1rIfREFvCB4pp8uF990Tz3PLXRJ5u_w-Y3vLxfXWKoxg/edit?tab=t.0#heading=h.umfo3mf3yzjx).
